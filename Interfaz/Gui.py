...
class App():
    def __init__(self):
        ...
        showTableCode.grid(column=1, row=0,padx=60)
        fDesTableCode.grid(column=0, row=0)
        self.spaceTableCode = scrolledtext.ScrolledText(self.frameTableCode,width=40,height=12)
        ...
        showTableSymbol.grid(column=1, row=0, padx=60)
        fDesTableSimbol.grid(column=0,row=0)
        self.spaceTableSymbol = scrolledtext.ScrolledText(self.frameTableSymbol,width=40,height=12)
